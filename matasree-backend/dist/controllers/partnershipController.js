...
exports.updatePartnershipStatus = exports.getAllPartnershipApplications = exports.getPartnershipApplicationById = exports.getPartnershipApplications = exports.submitPartnershipApplication = void 0;
const Partnership_1 = __importDefault(require("../models/Partnership"));
...
const submitPartnershipApplication = async (req, res) => {
    try {
        ...
        const { fullName, email, phone, businessName, businessType, areaOfInterest, cities, businessExperience, bankAccountHolder, bankAccountNumber, ifscCode, gstNumber, businessRegistration, address, city, state, pincode, country, additionalInfo, } = req.body;
        ...
        const existingApplication = await Partnership_1.default.findOne({
            userId,
        ...
        const partnershipData = new Partnership_1.default({
            userId,
            fullName,
            email,
            phone,
...
exports.submitPartnershipApplication = submitPartnershipApplication;
const getPartnershipApplications = async (req, res) => {
    try {
        const userId = req.user?.userId;
        // Get user's applications
        const applications = await Partnership_1.default.find({ userId }).sort({ createdAt: -1 });
        res.status(200).json({
            success: true,
            data: applications,
        });
...
exports.getPartnershipApplications = getPartnershipApplications;
const getPartnershipApplicationById = async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.user?.userId;
        const application = await Partnership_1.default.findById(id);
        if (!application) {
...
exports.getPartnershipApplicationById = getPartnershipApplicationById;
// Admin functions
const getAllPartnershipApplications = async (req, res) => {
    try {
        ...
        const applications = await Partnership_1.default.find(query)
            .skip(skip)
            .limit(Number(limit))
            .sort({ createdAt: -1 })
            .populate('userId', 'name email phone');
        const total = await Partnership_1.default.countDocuments(query);
        res.status(200).json({
            success: true,
            data: applications,
            pagination: {
...
exports.getAllPartnershipApplications = getAllPartnershipApplications;
const updatePartnershipStatus = async (req, res) => {
    try {
        ...
        const partnership = await Partnership_1.default.findByIdAndUpdate(id, {
            status,
...
exports.updatePartnershipStatus = updatePartnershipStatus;
