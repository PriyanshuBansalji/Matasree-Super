...
const seasonalBannerSchema = new mongoose_1.Schema({
    image: {
        type: String,
        required: true,
        trim: true,
...
exports.default = mongoose_1.default.model('SeasonalBanner', seasonalBannerSchema);
//# sourceMappingURL=SeasonalBanner.js.map